...
$_SESSION['helptext'] = "'This is the help text that is specific to the delete customer form'";
include 'head.php';
?>
            <form name="delete_customer" id="delete_customer" method="post" onsubmit="return confirmCheck()" action="delete_customer.php" >             
                <h2>Delete Customer  <img src="../common/images/help-01.png" alt="Help" id="helpbtn" onmousedown="frameToggleHelp() " > </h2><?php
